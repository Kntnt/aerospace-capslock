...
layout_rows = [
    ("Caps + L", "Switch tiles / accordion in the current group", "ctrl-alt-cmd-l", "layout tiles accordion"),
    ("Caps + R", "Rotate the group: horizontal / vertical", "ctrl-alt-cmd-r", "layout horizontal vertical"),
    ("Caps + F", "Fill the workspace / restore", "ctrl-alt-cmd-f", "fullscreen"),
    ("Caps + Shift + F", "Float this window / return it to tiling", "ctrl-alt-cmd-shift-f", "layout floating tiling"),
...
canvas.setTitle("AeroSpace - Caps Lock cheat sheet")
...
table([
    ...
    ["Caps + arrow", "Move focus"],
    ["Caps + Shift + arrow", "Move the window / move it out of a group"],
